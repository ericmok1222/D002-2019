...
bill_1=ceil(bill/100)
print(bill_1)
print("Kevin paid the bill first. But Kevin only has 100 dollar notes")
print("So Kevin is going to paid $%d."%(bill_1*100))   # replace with your code
print("The cafe is giving %f to Kevin." %(bill_1*100-bill))  # replace with your code
